...
- runnable: 5/5 - Stdlib-only commands, examples, demo artifacts, tests, selfcheck, and privacy scan.
- user_value: 4/5 - Maps local catalysts to thesis claims, exposure, warnings, and human review prompts.
- evidence: 4/5 - Includes deterministic demo JSON/Markdown/HTML, compare outputs, tests, and release validation.
- engineering: 4/5 - Typed dataclasses, deterministic rendering, focused CLI surface, and no runtime dependencies.
- showcase: 4/5 - Demo packet, compare packet, review doc, and agent skill show the intended workflow.
