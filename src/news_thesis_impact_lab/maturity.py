...
RATIONALE = {
    ...
    "user_value": "Maps local catalysts to thesis claims, exposure, warnings, and human review prompts.",
    "evidence": "Includes deterministic demo JSON/Markdown/HTML, compare outputs, tests, and release validation.",
    "engineering": "Typed dataclasses, deterministic rendering, focused CLI surface, and no runtime dependencies.",
    "showcase": "Demo packet, compare packet, review doc, and agent skill show the intended workflow.",
